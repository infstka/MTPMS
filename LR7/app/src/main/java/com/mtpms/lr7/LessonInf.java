...
import static com.mtpms.lr7.R.id.day;
...
public class LessonInf extends AppCompatActivity {
    ...
    private void delItem()
    {
        try
        {
            ...
            sql.execSQL("DELETE FROM " + DB.DB_TABLE + " WHERE name = '" + Lesson.Name + "' AND day = '" + Lesson.Day + "' AND week = " + Lesson.Week);
        }
        catch (Exception exc)
        {
