...
public class MainActivity extends AppCompatActivity {
    ...
    {
        Fragment FragmentLessonList = new FragmentLessonList();
        Fragment FragmentLessonDir = new FragmentLessonDir();

        Bundle bundle = new Bundle();
        bundle.putString("day", dayOfWeek);
        bundle.putInt("week", currentNumberOfWeek);
        FragmentLessonList.setArguments(bundle);

        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        ft.add(R.id.lessonList, FragmentLessonList);
        ft.add(R.id.lessonDirection, FragmentLessonDir);
        ft.commit();
    }
    ...
    {
        FragmentLessonDir fragment = (FragmentLessonDir) getSupportFragmentManager().findFragmentById(R.id.lessonDirection);
        if(fragment != null)
